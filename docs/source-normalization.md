...
Debug responses include lightweight request metadata, normalize duplicate or aliased section names, and reject unknown section names with a `400` response.
